...
class commonfunction
{
    ...
    {
        $CI = & get_instance();
        if($CI->session->userdata('group_id') == self::GROUP_ADMIN) {
            return true;
        } else {
            return false;
        }
    ...
    {
        $CI = & get_instance();
        if($CI->session->userdata('group_id') == self::GROUP_STUDENT) {
            return true;
        } else {
            return false;
        }
	...
	/**
     * Hàm check có phải thuộc nhóm quyền giáo viên
     * @return bool
     */
    public static function isteacher()
    {
        $CI = & get_instance();
        if($CI->session->userdata('group_id') == self::GROUP_TEACHER) {
            return true;
        } else {
            return false;
        }
